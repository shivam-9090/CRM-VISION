...
export default function EditActivityPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      await api.patch(`/activities/${activityId}`, formData);
      ...
      if (err && typeof err === 'object' && 'response' in err) {
        ...
        if (response?.data?.errors) {
          ...
          setErrors({ general: response?.data?.message || 'Failed to update activity' });
        }
      } else {
        setErrors({ general: 'Failed to update activity' });
      }
      ...
      <div className="flex">
        ...
        <div className="flex-1 p-8 bg-gray-50 min-h-screen animate-fade-in">
          <div className="flex items-center justify-center h-64">
            <div className="text-black">Loading activity...</div>
          </div>
        </div>
      </div>
    );
    ...
    <div className="flex">
      ...
      <div className="flex-1 p-8 bg-gray-50 min-h-screen animate-fade-in">
        <div className="mb-8">
          ...
          <h1 className="text-3xl font-bold text-black animate-slide-in-left">Edit Activity</h1>
        </div>
