...
export default function RegisterPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (!isConnected) {
      setError(
        "Cannot connect to backend server. Please check if the server is running on port 3001."
      );
      setLoading(false);
      return;
    }
    ...
    try {
      ...
      if (!response.data.user || !token) {
        ...
        setError(
          "Registration successful but authentication data is incomplete. Please try logging in."
        );
        setLoading(false);
        return;
      }
      ...
      if (!storedToken || !storedUser) {
        ...
        setError(
          "Registration successful but session initialization failed. Please try logging in."
        );
        setLoading(false);
        return;
      }
          ...
          <Card className="shadow-2xl border-0">
            <CardHeader className="text-center pb-2">
              ...
              <p className="text-gray-700 mt-2 font-medium">
                Join thousands of businesses using our CRM platform.
              </p>
            </CardHeader>
            <CardContent className="pt-6">
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <Input
                  ...
                  required
                  minLength={2}
                  placeholder="Enter your company name (min 2 characters)"
                />
                ...
                <div className="bg-blue-50 border border-blue-200 rounded-xl p-4">
                  <div className="flex items-center text-blue-800">
                    ...
                    <span className="text-sm font-bold">
                      By creating an account, you&apos;ll get your own company
                      workspace with full CRM access.
                    </span>
                  </div>
                </div>
        ...
        <div className="relative z-10 flex flex-col justify-center px-12 text-white">
          <div className="mb-8">
            ...
            <h2 className="text-4xl font-bold mb-4">
              Start managing your business relationships
            </h2>
            <p className="text-xl text-green-100 leading-relaxed">
              Join thousands of businesses who trust our CRM to grow their
          ...
          <div className="space-y-6">
            <div className="flex items-start">
              ...
              <div>
                ...
                <p className="text-green-100">
                  Organize all your contacts, companies, and relationships in
            ...
            <div className="flex items-start">
              ...
              <div>
                ...
                <p className="text-green-100">
                  Track deals, automate follow-ups, and never miss an
                  opportunity again.
                </p>
              </div>
            </div>
            ...
            <div className="flex items-start">
              ...
              <div>
                ...
                <p className="text-green-100">
                  Get insights into your sales performance and customer behavior
                  patterns.
                </p>
              </div>
            </div>
