...
export const DEFAULT_ROLE_PERMISSIONS = {
  ...
  MANAGER: [
    ...
    PERMISSIONS.COMPANY_ALL, // Full company access
    PERMISSIONS.USER_READ,
    PERMISSIONS.USER_UPDATE, // Can update user profiles
    PERMISSIONS.USER_INVITE,
    PERMISSIONS.COMMENT_ALL,
    PERMISSIONS.ANALYTICS_ALL, // Full analytics access
    PERMISSIONS.DATA_ALL, // Full import/export access
    PERMISSIONS.AUDIT_READ,
    PERMISSIONS.EMAIL_ALL, // Full email access
    PERMISSIONS.ATTACHMENT_ALL,
    PERMISSIONS.NOTIFICATION_ALL, // Full notification access
  ...
  EMPLOYEE: [
    PERMISSIONS.DEAL_READ,
    PERMISSIONS.DEAL_CREATE,
    PERMISSIONS.DEAL_UPDATE, // Added - employees need to update deals they're working on
    PERMISSIONS.DEAL_EXPORT, // Added - employees can export deals
    PERMISSIONS.CONTACT_READ,
    PERMISSIONS.CONTACT_EXPORT, // Added - employees can export contacts
    PERMISSIONS.ACTIVITY_CREATE,
    PERMISSIONS.ACTIVITY_READ,
    PERMISSIONS.ACTIVITY_UPDATE,
    PERMISSIONS.ACTIVITY_EXPORT, // Added - employees can export activities
    PERMISSIONS.COMPANY_READ,
    PERMISSIONS.USER_READ,
    PERMISSIONS.COMMENT_CREATE,
    PERMISSIONS.COMMENT_READ,
    PERMISSIONS.DATA_EXPORT, // Added - employees can export data
    PERMISSIONS.DATA_IMPORT,
    PERMISSIONS.EMAIL_SEND,
    PERMISSIONS.ATTACHMENT_CREATE,
    PERMISSIONS.ATTACHMENT_READ,
